        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-10">
                <div class="about-image-wrap">
                    <img class="img-full" src="{{asset('public/frontend/images/product/large-size/13.jpg')}}" alt="About Us" />
                </div>
            </div>
            <!-- About Image End -->
        </div>
        ...
        <div class="row no-gutters">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="container">
                        <div class="counter-img">
                            <img src="{{asset('public/frontend/images/about-us/icon/1.png')}}" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{asset('public/frontend/images/about-us/icon/2.png')}}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="counter-img">
                        <img src="{{asset('public/frontend/images/about-us/icon/3.png')}}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">456</h3>
                        </div>
                        <div class="counter-text">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{asset('public/frontend/images/about-us/icon/4.png')}}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">789</h3>
                        </div>
                        <div class="counter-text">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-member mb-30 mb-sm-60 mb-xs-60">
                    <div class="team-thumb">
                        <img src="{{asset('public/frontend/images/team/4.png')}}" alt="Our Team Member">
                    </div>
                    <div class="team-content text-center">
                        <h3>Maria Mandy</h3>
