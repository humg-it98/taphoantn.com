                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        <div class="product-review">
                                            <h5 class="manufacturer">
                                                <a href="shop-left-sidebar.html">ID sản phẩm: {{$product->product_id}}</a>
                                            </h5>
                                        ...
                                        <h4><a class="product_name" href="{{URL::to('/chi-tiet-san-pham',$product->product_slug)}}">{{$product->product_name}}</a></h4>
                                        <div class="price-box">
                                    ...
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            <li class="add-cart active add-to-cart" name="add-to-cart" data-id_product="{{$product->product_id}}" ><a href="#">Add to cart</a></li>
                                            <li><a class="links-details" href="wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                                            <li><a title="quick view" class="quick-view-btn xemnhanh" data-id_product="{{$product->product_id}}" data-toggle="modal" data-target="#xemnhanh"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
