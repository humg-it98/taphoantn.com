                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <div class="price-box">
                                            <span class="new-price">{{number_format($product_phone->product_price,0,',','.')}}VNĐ</span>
                                        </div>
                                    </div>
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            <li class="add-cart active add-to-cart" name="add-to-cart" data-id_product="{{$product_phone->product_id}}" ><a>Thêm giỏ hàng</a></li>
                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <div class="price-box">
                                            <span class="new-price">{{number_format($product_lap->product_price,0,',','.')}}VNĐ</span>
                                        </div>
                                    </div>
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <div class="price-box">
                                            <span class="new-price">{{number_format($product_tab->product_price,0,',','.')}}VNĐ</span>
                                        </div>
                                    </div>
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                ...
                                <div class="product_desc">
                                    ...
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            <li class="add-cart active"><a href="#">Add to cart</a></li>
                                            <li><a class="links-details" href="wishlist.html"><i class="fa fa-heart-o"></i></a></li>
                                            <li><a href="#" title="Xem nhanh" class="quick-view-btn xemnhanh" data-toggle="modal" data-target="#xemnhanh"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
