		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: cadetblue;padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					<h4 style="margin:0">CÔNG TY BÁN HÀNG 1 THÀNH VIÊN</h4>
				...
				<p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="">Shop</a>, hoặc liên hệ qua số hotline: 19008888. Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
