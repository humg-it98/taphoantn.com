...
class VideoController extends Controller
{
    ...
    public function update_video_image(Request $request){
     ...
     public function select_video(Request $request){
    	...
    	if($video_count>0){
    		...
    		$output.='
    				 <tr>
                                        <td colspan="4">Không có video hiển thị.</td>
    ...
    public function video_shop(Request $request){
        ...
        //seo
        $meta_desc = "Video công ty TNHH một thành viên Ghiền mua sắm";
        $meta_keywords = "Đồng hồ thời trang chính hãng ";
        $meta_title = "Videos NTN";
